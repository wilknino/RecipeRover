...
export default function UserInfoPanel({ user, isVisible, className }: UserInfoPanelProps) {
  ...
  return (
    <div className={cn(
      ...
      <div className="text-center">
        ...
        <h3 className="text-xl font-semibold mb-2" data-testid="text-user-full-name">
        ...
        <div className="space-y-4 text-left">
          ...
          <Card>
            <CardContent className="p-3">
              ...
              <p className="text-sm" data-testid="text-user-username">@{user.username}</p>
            </CardContent>
          </Card>
